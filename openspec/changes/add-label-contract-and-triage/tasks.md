...
- [ ] 7.1 Run `bun run lint:oxfmt`, `lint:eslint`, `lint:markdown`, `lint:knip`, `lint:fallow`, `lint:marketplace`, `lint:types` and `bun run test`; all pass
- [ ] 7.2 Run `openspec validate add-label-contract-and-triage --strict`; it passes
